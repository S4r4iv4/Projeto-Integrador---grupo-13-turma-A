...
public class projetoIntegrador {
  static int temp_dialog = 25, temp_narrativa = 40, temp_transicao = 70;
  ...
  public static void capitulo1() throws Exception {
    ...
    Digita("\nNarrador: Ao conectar no jogo, você sente uma dor estranha, mas não liga muito.", TimeUnit.MILLISECONDS,
        temp_narrativa);
    Digita("\nNarrador: No lobby no jogo, vc escuta uma voz familiar...", TimeUnit.MILLISECONDS, temp_narrativa);
    Digita("\n" + nome_rival + ": Ai, vc tbm sentiu aquilo? Doeu um pouco, mas deve ser o jogo calibrando né?",
        TimeUnit.MILLISECONDS, temp_narrativa);
    Digita("\n" + nome_rival + ": Caraca, olha esses gráficos! Parece mesmo a vida real!", TimeUnit.MILLISECONDS,
        temp_narrativa);
